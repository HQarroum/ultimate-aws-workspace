...
source "amazon-ebs" "al2-nvidia" {
  ...
  ami_description = "An AMI providing an Amazon linux 2 based instance with support for NVIDIA GPUs."
...
source "amazon-ebs" "al2-no-gpu" {
  ...
  ami_description = "An AMI providing an Amazon linux 2 based instance with support for an Xorg dummy driver."
